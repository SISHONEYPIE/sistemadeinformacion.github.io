<form action="metodos/insert.php" method="post">
    ...
    <div class="form-group">
        ...
        <select class="custom-select" id="servicio" name="servicio" required>
            ...
            <option value="Chocolate">Chocolate($566)</option>
            <option value="Vainilla">Vainilla($500)</option>
            <option value="Red belbed">Red belbed($750)</option>
            <option value="Tres leches">Tres leches($540)</option>
            <option value="Capuchino">Capuchino($480)</option>
            <option value="Strawberry fields">Strawberry fields($800)</option>
        </select>
    </div>
    ...
    <div class="form-group">
        ...
        <select class="form-control" id="hora" name="hora" required>
            <option value="" selected>Elige la hora de entrega</option>
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    function validarFecha() {
        ...
        */
        ...
        if (diaSemana !== 2 && diaSemana !== 3 && diaSemana !== 4 && diaSemana !== 5 && diaSemana !== 6 && diaSemana !== 0) {
